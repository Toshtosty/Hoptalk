...
import { LoaderIcon, MapPinIcon, Rabbit, ShuffleIcon,CameraIcon } from "lucide-react";
...
const OnboardingPage = () => {
  ...
  const handleRandomAvatar = () => {
    ...
    const randomAvatar = `https://api.dicebear.com/8.x/${randomStyle}/svg?seed=${encodeURIComponent(randomSeed)}`;
